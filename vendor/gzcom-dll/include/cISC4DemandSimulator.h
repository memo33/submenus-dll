...
public:
    ...
    */
     ...
     * @param exemplarInstanceLow The low 4 bytes of the exemplar instance ID.
     * @param exemplarInstanceHigh The high 4 bytes of the exemplar instance ID.
    */
    virtual void CalculateJobsPerUnitOfDemand(float* jobsArray, uint32_t exemplarInstanceLow, uint32_t exemplarInstanceHigh) = 0;
